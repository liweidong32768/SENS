...
//    private String CALLBACK_URL = SensConst.OPTIONS.get(BlogPropertiesEnum.bind_qq_callback.getProp());
//    // QQ 互联应用管理中心的 APP ID
//    private String APP_ID = SensConst.OPTIONS.get(BlogPropertiesEnum.bind_qq_app_id.getProp());
//    // QQ 互联应用管理中心的 APP Key
//    private String APP_SECRET = SensConst.OPTIONS.get(BlogPropertiesEnum.bind_qq_app_secret.getProp());
